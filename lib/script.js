document.addEventListener('DOMContentLoaded', function() {
        ...
        for (let row = 5; row >= 0; row--) {
            ...
            if (!cell.classList.contains('red') && !cell.classList.contains('yellow')) {
                ...
                if (checkWin()) {
                    ...
                    winnerAnnouncement.textContent = `Félicitations, ${currentPlayer} a gagné!`;
                    return;
                }
                changePlayer();
                break;
    ...
    function checkWin() {
        return checkDirection(-1, 0) || checkDirection(1, 0) ||  // Vertical
               checkDirection(0, 1) || checkDirection(0, -1) ||  // Horizontal
               checkDirection(-1, -1) || checkDirection(1, 1) || // Diagonal (up-left to down-right)
               checkDirection(-1, 1) || checkDirection(1, -1);   // Diagonal (down-left to up-right)
    }
